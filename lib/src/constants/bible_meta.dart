/// Structural metadata for all 66 books of the Bible.
///
...
class BibleMeta {
  ...
  /// Whether [book] is in the Old Testament.
  static bool isOldTestament(String book) => oldTestament.contains(book);

  /// Whether [book] is in the New Testament.
  static bool isNewTestament(String book) => newTestament.contains(book);

  /// Chapter count for [book], or 0 if unknown.
  static int chaptersIn(String book) => chapterCounts[book] ?? 0;
}
